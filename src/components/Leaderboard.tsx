...
const LEADERS = [
  { rank: 1, name: "@michantech", looms: 2005, change: "up", uni: "KNUST" },
  { rank: 2, name: "@Light", looms: 915, change: "up", uni: "KNUST" },
  { rank: 3, name: "@lightyear_", looms: 30, change: "up", uni: "KNUST" },
  { rank: 4, name: "@kofi_show", looms: 15, change: "up", uni: "KNUST" },
  { rank: 5, name: "@scouty", looms: 15, change: "up", uni: "KNUST" },
  { rank: 6, name: "@clifford_hesa", looms: 15, change: "up", uni: "KNUST" },
  { rank: 7, name: "@asante_dev", looms: 15, change: "up", uni: "KNUST" },
];
    ...
    <div className="w-full glass-light p-6 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border border-white shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 md:mb-12 relative z-10 text-left">
        ...
        <div className="md:text-right">
          ...
          <p className="text-lg md:text-xl font-black text-primary">3.2k+ Looms</p>
        </div>
      </div>
        ...
        {LEADERS.map((user, i) => (
          ...
          >
            <div className="flex items-center gap-4">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-black text-xs ${user.rank === 1 ? "bg-yellow-400 text-white" :
