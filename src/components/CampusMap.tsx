        ...
        <ScrollReveal direction="right" className="flex-1 text-center md:text-left">
          ...
          <div className="grid grid-cols-2 gap-6 max-w-sm">
            <div className="flex flex-col gap-2">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Universites</span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-3xl font-black text-slate-900">600k+</span>
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Potential Student Connections</span>
            </div>
          </div>
        </ScrollReveal>
      </div>
